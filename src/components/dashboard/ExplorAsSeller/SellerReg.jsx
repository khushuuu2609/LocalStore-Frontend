...
function SellerReg() {
    ...
    async function handleSubmit(e) {
        ...
        const roleUpdateResponse = await fetch(`http://localhost:8080/api/auth/upgradeToSeller/${userToken.userId}`, {
            method: 'PATCH',
            headers: { 'Content-Type': 'application/json' },
    ...
    return (
        ...
        <form onSubmit={handleSubmit} ref={form}>
            <div className="mb-3">
                ...
                <select  className="form-select" id="categories" name="categories" multiple>
                        {
