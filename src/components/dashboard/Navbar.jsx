                    ...
                    <nav className="navbar navbar-light navbar-expand-xl  ">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse">
                            <div className="navbar-nav mx-auto ">
                                <NavLink to="home" className="nav-item nav-link"><b>Home</b></NavLink>
                                <NavLink to="shop" className="nav-item nav-link"><b>Shop</b></NavLink>
                                <NavLink to="orders" className="nav-item nav-link"><b>Orders</b></NavLink>
                                <NavLink to="seller" className="nav-item nav-link"><b>Explore as Seller</b></NavLink>
                                <NavLink to="contact" className="nav-item nav-link"><b>Contact Us</b></NavLink>
                            </div>
                            <div className="d-flex m-3 me-0">
                                <NavLink to="/notification" className="position-relative me-4 my-auto">
