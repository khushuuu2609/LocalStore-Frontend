            ...
            <div className="bg-white poppins z-50 flex items-center justify-between px-12 py-6 top-0 sticky shadow-2xl scroll-smooth">
                ...
                <div>
                    <ul className="flex w-full justify-between items-center gap-8">
                        ...
                        {role === "SELLER" && (
                            <li>
                                <NavLink to={"/work-space"}>Workspace</NavLink>
                            </li>
                        )}
                        <li>
                        ...
                        <li>
                            <button
                                onClick={logout}
                                className="bg-red-600 py-2 px-8 text-white pb-3 rounded-3xl hover:bg-red-700  active:bg-red-600"
                            >
                                Logout
                            </button>
                        </li>
